...
reqenv "L2_FINALIZE_PERIOD"
reqenv "L2_GOV_SYMBOL"
reqenv "L2_GOV_NAME"
reqenv "L1_RPC_URL"
...
config=$(cat << EOL
{
  ...
  "finalizationPeriodSeconds": $L2_FINALIZE_PERIOD,
  ...
  "governanceTokenSymbol": "$L2_GOV_SYMBOL",
  "governanceTokenName": "$L2_GOV_NAME",
